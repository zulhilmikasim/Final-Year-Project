...
import com.test.user.RoundTripReceipt.RoundTripTicketConfirmationActivity;
import com.test.user.Ticket.TicketInformation;

import java.util.ArrayList;
import java.util.List;

public class SeatActivity3 extends AppCompatActivity implements AdapterView.OnItemClickListener{

    GridView gridView;
    ArrayList<Item3> gridArray = new ArrayList<Item3>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customGridAdapter = new CustomGridViewAdapter3(this, R.layout.seatrow_grid, gridArray,num);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SeatActivity3.this, RoundTripTicketConfirmationActivity.class));
            }
        });
    ...
    public void totalSeat(int n)
    {
        for (int i = 1; i <= n; ++i)
        {
            gridArray.add(new Item3(seatIcon, "seat " + i));
        }
    ...
    public void seatSelected(int pos)
    {
        ...
        gridArray.add(pos, new Item3(seatSelect, "selected"));
    ...
    {
        gridArray.add(pos, new Item3(seatBook, "booked"));
        //list.add(String.valueOf("Seat " + (pos+1)));
    ...
    public void seatDeselcted(int pos)
    {
        ...
        gridArray.remove(pos);
        int i = pos + 1;
        gridArray.add(pos, new Item3(seatIcon, "seat" +i ));
    ...
    {
        Item3 item = gridArray.get(position);
        ...
        /*final String joined = TextUtils.join(", ", list);
        t1 = (TextView)findViewById(R.id.text);
        t1.setText(joined);*/
        ...
        myRef2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                addlist = seatnum.child("ReturnSeat");
    ...
    public void MyCustomAlertDialog() {
        dialog = new Dialog(SeatActivity3.this);
