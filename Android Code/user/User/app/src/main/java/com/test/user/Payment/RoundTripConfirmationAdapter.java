...
public class RoundTripConfirmationAdapter extends RecyclerView.Adapter<RoundTripConfirmationAdapter.MyViewHolder> {
    ...
    public RoundTripConfirmationAdapter(Context mContext, ArrayList<Confirmation> confirmations,String payment, String seatnum) {
    ...
    @Override
    public RoundTripConfirmationAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new RoundTripConfirmationAdapter.MyViewHolder(itemView);
    }
    ...
    @Override
    public void onBindViewHolder(RoundTripConfirmationAdapter.MyViewHolder holder, int position) {
