...
import com.test.user.Seat.SeatActivity3;

import java.util.ArrayList;

public class ReturnScheduleAdapter extends RecyclerView.Adapter<ReturnScheduleAdapter.MyViewHolder>{
    ...
    public ReturnScheduleAdapter(Context mContext, ArrayList<Schedule> mProductList) {
        this.mContext = mContext;
        this.mProductList = mProductList;
    }

    @Override
    public ReturnScheduleAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.model,null,false);
        itemView.setLayoutParams(new RecyclerView.LayoutParams(RecyclerView.LayoutParams.MATCH_PARENT, RecyclerView.LayoutParams.WRAP_CONTENT));
        return new ReturnScheduleAdapter.MyViewHolder(itemView);
    }
        ...
        public MyViewHolder(View itemView) {
            ...
            btnNext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String push = list.child("ReturnTicket").push().getKey();
                    model.setId("BKM" + push);
                    list.child("ReturnTicket").setValue(model);

                    Context context = v.getContext();
                    Intent intent = new Intent(context, SeatActivity3.class);
