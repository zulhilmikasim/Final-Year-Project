...
public class ScheduleSummaryAdapter extends RecyclerView.Adapter<ScheduleSummaryAdapter.MyViewHolder>{


    private Context mContext;
    private ArrayList<ScheduleSummary> summary;
    private ArrayList<TicketInformation> passangers;

    public ScheduleSummaryAdapter(Context mContext, ArrayList<ScheduleSummary> summary, ArrayList<TicketInformation> passangers) {
    ...
    @Override
    public ScheduleSummaryAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(ScheduleSummaryAdapter.MyViewHolder holder, int position) {
