...
public class ToScheduleSummaryAdapter extends RecyclerView.Adapter<ToScheduleSummaryAdapter.MyViewHolder>{


    private Context mContext;
    private ArrayList<ToScheduleSummary> summary;
    private ArrayList<ReturnTicketInformation> passangers;

    public ToScheduleSummaryAdapter(Context mContext, ArrayList<ToScheduleSummary> summary, ArrayList<ReturnTicketInformation> passangers) {
    ...
    @Override
    public ToScheduleSummaryAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.content_schedule,null,false);
        return new ToScheduleSummaryAdapter.MyViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(ToScheduleSummaryAdapter.MyViewHolder holder, int position) {
