...
import com.test.user.Receipt.TicketConfirmationActivity;
import com.test.user.Ticket.TicketInformation;

import java.util.ArrayList;
import java.util.List;

public class SeatActivity extends Activity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customGridAdapter = new CustomGridViewAdapter(this, R.layout.seatrow_grid, gridArray,num);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SeatActivity.this, TicketConfirmationActivity.class));
            }
        });
    ...
    {
        gridArray.add(pos, new Item(seatBook, "booked"));
        //list.add(String.valueOf("Seat " + (pos+1)));
    ...
    public void MyCustomAlertDialog() {
        dialog = new Dialog(SeatActivity.this);
